        ...
        <div className="flex flex-col justify-between h-full gap-4">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-2xl font-bold">
              {(activeClients !== undefined ? activeClients : 0)}
            </p>
          </div>
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-2xl font-bold">
              {(pendingSales !== undefined ? pendingSales : 0)}
            </p>
          </div>
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-2xl font-bold">
              S/ {(totalExpenses !== undefined ? totalExpenses.toLocaleString('es-PE', { minimumFractionDigits: 2 }) : 0)}
            </p>
          </div>
        </div>
      </CardContent>
